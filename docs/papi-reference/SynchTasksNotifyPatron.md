...
_Source: https://documentation.iii.com/polaris/PAPI/current/PAPIService/SynchTasksNotifyPatron.htm_
...
|  
| PUT
| /protected/1 {Version}/{LangID}/{AppID}/{OrgID}/{AccessToken}/synch/tasks/notifypatron
|  
...
|
| Message
| Patron notification message from a third-party vendor that integrates with Polaris.
