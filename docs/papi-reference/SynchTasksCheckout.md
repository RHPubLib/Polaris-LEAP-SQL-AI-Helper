...
_Source: https://documentation.iii.com/polaris/PAPI/current/PAPIService/SynchTasksCheckout.htm_

You are here:

## SynchTasksCheckout

Writes checkout transaction information into the Polaris database for additional processing within the Polaris ILS.

|
|  
| PUT
| /protected/1 {Version}/{LangID}/{AppID}/{OrgID}/{AccessToken}/synch/tasks/checkout
|  
...
<ItemExpireDateTime>2012-06-12T23:59:59</ItemExpireDateTime>
