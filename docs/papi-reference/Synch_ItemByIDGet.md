...
_Source: https://documentation.iii.com/polaris/PAPI/current/PAPIService/Synch_ItemByIDGet.htm_
...
|  
| GET
| /protected/1 {Version}/{LangID}/{AppID}/{OrgID}/{AccessToken}/synch/item/{ItemID}
|  
